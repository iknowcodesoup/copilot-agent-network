...
class RAGAnswer(BaseModel):
    is_answerable: bool = Field(description='True if the provided context explicitly contains the answer.')
    answer: str = Field(description='The final answer. If is_answerable is false, explain why.')
