...
class BamlSyncClient:
    ...
    def GenerateAnswer(self, context: str,question: str,
        ...
        if 'on_tick' in baml_options:
            __stream__ = self.stream.GenerateAnswer(context=context,question=question,
            ...
            return typing.cast(types.RAGAnswer, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def GenerateAnswer(self, context: str,question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.RAGAnswer, types.RAGAnswer]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateAnswer", args={
            "context": context,"question": question,
        })
        return baml_py.BamlSyncStream[stream_types.RAGAnswer, types.RAGAnswer](
          __result__,
          lambda x: typing.cast(stream_types.RAGAnswer, x.cast_to(types, types, stream_types, True, __runtime__)),
          lambda x: typing.cast(types.RAGAnswer, x.cast_to(types, types, stream_types, False, __runtime__)),
          __ctx__,
        )
